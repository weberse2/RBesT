...
(MAP) approach [@neuenschwander2010], the evaluation of the trial's operating
...
Let's look at the Crohn's disease example data [@hueber2012] (data-set `crohn`
...
recommend a "unit-information" prior [@kass1995] which is set to a precision
...
We recommend robustifying [@schmidli2014] the prior with the **`robustify`**
