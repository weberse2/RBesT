...
The co-data concept has been introduced in [@neuenschwander2016]. It differs from the
...
approach. This example has been discussed in [@neuenschwander2016] using the probability
...
In the following the hypothetical example as in [@neuenschwander2016] is discussed. The
...
[@schmidli2014]. The formal deriavtion is shown at the end of this section

While MAP and MAC provide the exact same results, the difference is a
sequential vs a joint analysis as (see also [@schmidli2014]):
