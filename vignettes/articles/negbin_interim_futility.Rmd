...
link-citations: true
nocite: |
  @neuenschwander2010, @schmidli2014, @gsponer2014
vignette: >
...
and partial follow-up. Hence, patients with partial follow-up at the
IA and will continue to be monitored past the IA until the final
...
another as shown in @Scharfstein1997 and @Muetze2018.
...
`asthma` data set (Table 1 of @holzhauer2018):
...
carry. An alternative, as poroposed by @gallo2014, fixes
...
[@gerber2016] provides a full analytic treatment of such
...
- Overdispersion $\kappa$ is treated as fixed. A more thorough
  ...
  its posterior uncertainty (cf. @holzhauer2018; see the
...
for a fixed design [@gallo2014], we can equally read the
