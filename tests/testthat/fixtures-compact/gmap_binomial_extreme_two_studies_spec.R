...
gmap_binomial_extreme_two_studies_compact_spec <- 
structure(list(name = "gmap_binomial_extreme_two_studies", seed = 873461L, 
    ...
    generation_config = list(recipe = "tests/testthat/fixtures-compact-src/gmap_binomial_extreme_two_studies_fixture.R", 
        nc = 1L, digits = 4L, seed = 873461L, data_objects = "data_extreme")), class = "compact_gmap_fixture_spec")

gmap_binomial_extreme_two_studies_compact_spec$mvn_model <- read_mix_json(
  testthat::test_path("fixtures-compact", "gmap_binomial_extreme_two_studies_mvn_model.json"),
  rescale = TRUE
)
gmap_binomial_extreme_two_studies_compact_spec$mvn_theta <- read_mix_json(
  testthat::test_path("fixtures-compact", "gmap_binomial_extreme_two_studies_mvn_theta.json"),
  rescale = TRUE
)
gmap_binomial_extreme_two_studies_compact_spec$builder <- function() {
  withr::with_options(
