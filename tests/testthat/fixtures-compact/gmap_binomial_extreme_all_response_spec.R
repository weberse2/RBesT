data_extreme <- 
structure(list(n = c(5, 5, 5, 5), r = c(5, 5, 5, 5), study = c(1, 
1, 1, 1)), class = "data.frame", row.names = c(NA, -4L))

gmap_binomial_extreme_all_response_compact_spec <- 
structure(list(name = "gmap_binomial_extreme_all_response", seed = 873461L, 
    ...
    "theta[2]", "theta[3]", "theta[4]", "tau[1]", "beta[1]", 
    ...
    generation_config = list(recipe = "tests/testthat/fixtures-compact-src/gmap_binomial_extreme_all_response_fixture.R", 
        nc = 1L, digits = 4L, seed = 873461L, data_objects = "data_extreme")), class = "compact_gmap_fixture_spec")

gmap_binomial_extreme_all_response_compact_spec$mvn_model <- read_mix_json(
  testthat::test_path("fixtures-compact", "gmap_binomial_extreme_all_response_mvn_model.json"),
  rescale = TRUE
)
gmap_binomial_extreme_all_response_compact_spec$mvn_theta <- read_mix_json(
  testthat::test_path("fixtures-compact", "gmap_binomial_extreme_all_response_mvn_theta.json"),
  rescale = TRUE
)
gmap_binomial_extreme_all_response_compact_spec$builder <- function() {
  withr::with_options(
